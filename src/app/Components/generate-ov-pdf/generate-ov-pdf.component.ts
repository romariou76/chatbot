...
import { PasarelaInvitadoService } from '../../Pages/pasarela-invitado/pasarela-invitado.service';

@Component({
  selector: 'app-generate-ov-pdf',
  standalone: true,
  imports: [],
  templateUrl: './generate-ov-pdf.component.html',
  styleUrl: './generate-ov-pdf.component.css'
})
export class GenerateOvPdfComponent {
  ...
  generar(){
    ...
    doc.text(': '+this.service.dni().dni, 48, 58 )
    doc.text(': '+ this.service.nombre() + ' ' + this.service.apellidos()  , 48, 61 )
